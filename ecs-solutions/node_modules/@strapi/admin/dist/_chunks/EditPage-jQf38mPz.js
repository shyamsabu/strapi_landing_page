...
const useWebhooks = require("./useWebhooks-zFX4g8NX.js");
...
const WebhookForm = ({
  ...
  const EventTable = index.useEnterprise(
    EventTableCE,
    async () => (await Promise.resolve().then(() => require("./EventsTable-vYoMUK2-.js"))).EventsTableEE
  );
...
//# sourceMappingURL=EditPage-jQf38mPz.js.map
