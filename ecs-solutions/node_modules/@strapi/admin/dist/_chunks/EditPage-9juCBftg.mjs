...
import { p as useEnterprise, j as useTypedSelector, x as isBaseQueryError } from "./index-ZPV-U3Z8.mjs";
...
import { u as useWebhooks } from "./useWebhooks-XhWIqLBZ.mjs";
...
const WebhookForm = ({
  ...
  const EventTable = useEnterprise(
    EventTableCE,
    async () => (await import("./EventsTable-_eoMsdvv.mjs")).EventsTableEE
  );
...
//# sourceMappingURL=EditPage-9juCBftg.mjs.map
